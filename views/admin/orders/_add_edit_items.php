...
<div class="panel-body">
            ...
            <div class="mtop10">
                ...
                <div class="radio radio-primary radio-inline">
                    <input type="radio" value="1" id="1" name="show_quantity_as"
                        data-text="<?php echo _l('order_table_quantity_heading'); ?>"
                        <?php echo isset($order) && $order->show_quantity_as == 1 ? 'checked' : 'checked'; ?>>
                    <label for="1"><?php echo _l('quantity_as_qty'); ?></label>
                </div>
                <div class="radio radio-primary radio-inline">
                    <input type="radio" value="2" id="2" name="show_quantity_as"
                        data-text="<?php echo _l('order_table_hours_heading'); ?>"
                        <?php echo isset($order) && $order->show_quantity_as == 2 ? 'checked' : ''; ?>>
                    <label for="2"><?php echo _l('quantity_as_hours'); ?></label>
                </div>
                <div class="radio radio-primary radio-inline">
                    <input type="radio" id="3" value="3" name="show_quantity_as"
                        data-text="<?php echo _l('order_table_quantity_heading'); ?>/<?php echo _l('order_table_hours_heading'); ?>"
                        <?php echo isset($order) && $order->show_quantity_as == 3 ? 'checked' : ''; ?>>
                    <label for="3">
                        <?php echo _l('order_table_quantity_heading'); ?>/<?php echo _l('order_table_hours_heading'); ?>
                    </label>
                </div>
            </div>
        </div>
    ...
    <div class="table-responsive s_table">
        <table class="table order-items-table items table-main-order-edit has-calculations no-mtop">
            <thead>
                <tr>
                    <th></th>
                    <th width="20%" align="left"><i class="fa-solid fa-circle-exclamation tw-mr-1" aria-hidden="true"
                        ...
                        <?php echo _l('order_table_item_heading'); ?></th>
                    <th width="25%" align="left"><?php echo _l('order_table_item_description'); ?></th>
                    <?php
                  ...
                  if (isset($order) && $order->show_quantity_as == 2) {
                      $qty_heading = _l('order_table_hours_heading');
                  } elseif (isset($order) && $order->show_quantity_as == 3) {
                      $qty_heading = _l('order_table_quantity_heading') . '/' . _l('order_table_hours_heading');
                  }
                  ?>
                    <th width="10%" class="qty" align="right"><?php echo $qty_heading; ?></th>
                    <th width="15%" align="right"><?php echo _l('order_table_rate_heading'); ?></th>
                    <th width="20%" align="right"><?php echo _l('order_table_tax_heading'); ?></th>
                    <th width="10%" align="right"><?php echo _l('order_table_amount_heading'); ?></th>
                ...
                <?php if (isset($order) || isset($add_items)) {
                         ...
                         foreach ($add_items as $item) {
                             ...
                             if (!isset($is_proposal)) {
                                 $order_item_taxes = get_order_item_taxes($item['id']);
                             } else {
                                 $order_item_taxes = get_proposal_item_taxes($item['id']);
                             }
                             if ($item['id'] == 0) {
                             ...
                             $table_row .= '<td class="taxrate">' . $this->misc_model->get_taxes_dropdown_template('' . $items_indicator . '[' . $i . '][taxname][]', $order_item_taxes, (isset($is_proposal) ? 'proposal' : 'order'), $item['id'], true, $manual) . '</td>';
    ...
    <div class="col-md-8 col-md-offset-4">
        <table class="table text-right">
            <tbody>
                <tr id="subtotal">
                    <td><span class="bold tw-text-neutral-700"><?php echo _l('order_subtotal'); ?> :</span>
                    </td>
                    <td class="subtotal">
                    </td>
                </tr>
                <tr id="discount_area">
                    <td>
                        <div class="row">
                            <div class="col-md-7">
                                <span class="bold tw-text-neutral-700"><?php echo _l('order_discount'); ?></span>
                            </div>
                            <div class="col-md-5">
                                <div class="input-group" id="discount-total">
                                    ...
                                    <input type="number"
                                        ...
                                        class="form-control pull-left input-discount-percent<?php if (isset($order) && !is_sale_discount($order, 'percent') && is_sale_discount_applied($order)) {
                   echo ' hide';
                                    ...
                                    <input type="number" data-toggle="tooltip"
                                        ...
                                        value="<?php echo(isset($order) ? $order->discount_total : 0); ?>" class="form-control pull-left input-discount-fixed<?php if (!isset($order) || (isset($order) && !is_sale_discount($order, 'fixed'))) {
                   echo ' hide';
                   ...
                   echo _l('discount_fixed_amount');
                                    ...
                                    ?>
                                            ...
                                            <ul class="dropdown-menu" id="discount-total-type-dropdown"
                                                ...
                                                <li>
                                                    <a href="#" class="discount-total-type discount-type-percent<?php if (!isset($order) || (isset($order) && is_sale_discount($order, 'percent')) || (isset($order) && !is_sale_discount_applied($order))) {
                                        echo ' selected';
                                    } ?>">%</a>
                                                </li>
                                                <li>
                                                    <a href="#" class="discount-total-type discount-type-fixed<?php if (isset($order) && is_sale_discount($order, 'fixed')) {
                                        echo ' selected';
                                    } ?>">
                ...
                <tr>
                    <td>
                        <div class="row">
                            <div class="col-md-7">
                                <span class="bold tw-text-neutral-700"><?php echo _l('order_adjustment'); ?></span>
                            </div>
                            <div class="col-md-5">
                                <input type="number" data-toggle="tooltip"
                                    data-title="<?php echo _l('numbers_not_formatted_while_editing'); ?>" value="<?php if (isset($order)) {
                ...
                <tr>
                    <td><span class="bold tw-text-neutral-700"><?php echo _l('order_total'); ?> :</span>
                    </td>
                    <td class="total">
                    </td>
                </tr>
