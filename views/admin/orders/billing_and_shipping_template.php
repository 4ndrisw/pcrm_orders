                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                      ...
                      <div class="form-group no-mbot">
                            ...
                            <input type="checkbox" id="include_shipping" name="include_shipping" <?php if (isset($order) && $order->include_shipping == 1) {
    echo 'checked';
} ?>>
                            <label for="include_shipping"><?php echo _l('shipping_address'); ?></label>
                        </div>
                      </div>
                        <div id="shipping_details" class="<?php if ((isset($order) && $order->include_shipping != 1) || !isset($order)) {
    echo 'hide';
} ?>">
                        <div class="form-group">
                                <div class="checkbox checkbox-primary checkbox-inline">
                                <input type="checkbox" id="show_shipping_on_order" name="show_shipping_on_order" <?php if ((isset($order) && $order->show_shipping_on_order == 1) || !isset($order)) {
    echo 'checked';
} ?>>
                                <label for="show_shipping_on_order"><?php echo _l('show_shipping_on_order'); ?></label>
                            </div>
                        </div>
